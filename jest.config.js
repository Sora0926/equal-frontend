...
const customJestConfig = {
  ...
  // An array of regular expression patterns to match against plugins in all source files before re-running the test in watch mode.
  watchPlugins: [
